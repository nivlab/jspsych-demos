var jsPsychSymmetryJudgmentTaskDisplay = (function (jspsych) {
  'use strict';
  ...
  */
  class SymmetryJudgmentTaskDisplayPlugin {
    constructor(jsPsych) {
  ...
  SymmetryJudgmentTaskDisplayPlugin.info = info;

  return SymmetryJudgmentTaskDisplayPlugin;
