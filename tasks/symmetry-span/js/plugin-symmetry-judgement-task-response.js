var jsPsychSymmetryJudgmentTaskResponse = (function (jspsych) {
  'use strict';
  ...
  */
  class SymmetryJudgmentTaskResponsePlugin {
    constructor(jsPsych) {
  ...
  SymmetryJudgmentTaskResponsePlugin.info = info;

  return SymmetryJudgmentTaskResponsePlugin;
