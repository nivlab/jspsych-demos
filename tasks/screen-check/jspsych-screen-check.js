...
var jsPsychScreenCheck = (function (jspsych) {
  ...
  const info = {
    ...
    parameters: {
      /**
      * The minimum width (in pixels) of browser window for the experiment to continue.
      */
      min_width: {
      ...
      /**
      * The minimum height (in pixels) of browser window for the experiment to continue.
      */
      min_height: {
        type: jspsych.ParameterType.INT,
        default: null,
