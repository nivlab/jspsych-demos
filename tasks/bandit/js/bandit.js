var jsPsychBandit = (function (jspsych) {
  'use strict';
  ...
  const info = {
      ...
      parameters: {
          ...
          face_stimuli: {
              ...
              pretty_name: "face_stimuli",
              default: undefined,
          },
          /** The array of paths to place stimuli */
          place_stimuli: {
              type: jspsych.ParameterType.STRING,
              pretty_name: "place_stimuli",
              default: undefined,
          },
          /** The array of paths to feedback stimuli */
          feedback_images: {
              type: jspsych.ParameterType.STRING,
              pretty_name: "feedback_images",
              default: undefined,
          },
          /** The mapping to subject-specific images (allows randomisation of visual stimuli) */
          image_allocation: {
          ...
          /* The dimensions [width, height] of the html canvas on which things are drawn */
          canvas_dimensions: {
          ...
          /** Set the image height in pixels - The offset [horizontal, vertica] of the centre of each stimulus from the centre of the canvas in pixels'*/
          stimulus_offset: {
            type: jspsych.ParameterType.INT,
            pretty_name: 'Stimulus offset',
            default: [270, 0],
          },
          /*Stimulus dimensions in pixels [width, height] */
          stimulus_dimensions: {
            type: jspsych.ParameterType.INT,
            pretty_name: 'Stimulus dimensions',
            default: [250, 250],
          },
          /* The key to be pressed to select the left planet*/
          left_key: {
            type: jspsych.ParameterType.KEYCODE,
            pretty_name: 'Left key',
            default: 'ArrowLeft',
          },
          /* The key to be pressed to select the right planet*/
          right_key: {
            type: jspsych.ParameterType.KEYCODE,
          ...
          /*How long to display the response (in milliseconds).'*/
          ...
          /*How long to display a blank screen between trials (in milliseconds).'*/
          iti_duration: {
            type: jspsych.ParameterType.INT,
            pretty_name: 'Duration of inter-trial interval',
            default: 1500,
          },
          /*Thickness (in pixels) of the selection box'*/
          selection_pen_width: {
            type: jspsych.ParameterType.INT,
          ...
          /*The offset [horizontal, vertica] of the centre of the feedback from the centre of the canvas in pixels'*/
          feedback_offset: {
            type: jspsych.ParameterType.INT,
            pretty_name: 'Feedback offset',
            default: [0, 0],//[270, -200],
          },
          /*Feedback image dimensions in pixels [width, height]'*/
          feedback_dimensions: {
            type: jspsych.ParameterType.INT,
            pretty_name: 'Feedback dimensions',
            default: [120, 120],
          },
          /*The colour of the selection box during reward feedback'*/
          reward_colour: {
            type: jspsych.ParameterType.STRING,
            default: '#00CA33', // #00CA33 is green
          },
          /*The colour of the selection box during non-reward feedback'*/
          non_reward_colour: {
            type: jspsych.ParameterType.STRING,
   ...
   *
   * @author Dan Bennett // to 7.2 Gili Karni
   */
  class BanditPlugin {
      constructor(jsPsych) {
      ...
      trial(display_element, trial) {
          ...
          var new_html = '<div id="jspsych-canvas-keyboard-response-stimulus">' +
              '<canvas id="trial_canvas" width="' +
              trial.canvas_dimensions[0] +
              '" height="' +
              trial.canvas_dimensions[1] +
              '"></canvas>' +
              "</div>";
          // add prompt
